#!/bin/bash
# 定义主脚本的下载URL
DEBIAN_MAIN_SCRIPT_URL="https://raw.githubusercontent.com/gwd0715/sbshell/refs/heads/main/debian/menu.sh"
OPENWRT_MAIN_SCRIPT_URL="https://raw.githubusercontent.com/gwd0715/sbshell/refs/heads/main/openwrt/menu.sh"
